...
$query0 = mysqli_query($connect_bd, "DELETE FROM `oc_manufacturer_to_layout`");

$query1_string = "SELECT * FROM `oc_manufacturer`";
$query1 = mysqli_query($connect_bd, $query1_string);

$query2_string = "INSERT INTO `oc_manufacturer_to_layout` (
`manufacturer_id`,
`store_id`,
`layout_id`) VALUES ";
while ($arrayManufacturer_id = mysqli_fetch_assoc($query1)) {
    ...
    $query2_string .= " ({$manufacturer_id}, {$store_id}, {$layout_id}),";
